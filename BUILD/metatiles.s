...
; hero_velocity_x = 0;
;
L029C:	sta     _hero_velocity_x
	stx     _hero_velocity_x+1
;
; hero_x += hero_velocity_x;
;
L01CF:	lda     _hero_velocity_x
	clc
	adc     _hero_x
	sta     _hero_x
...
; hero_velocity_y = 0;
;
L02A2:	sta     _hero_velocity_y
	stx     _hero_velocity_y+1
;
; hero_y += hero_velocity_y;
;
L0217:	lda     _hero_velocity_y
	clc
	adc     _hero_y
	sta     _hero_y
...
;
L0285:	ldy     _coordinates
	lda     _c_map2,y
L02AB:	sta     _collision
;
; }
;
	rts
